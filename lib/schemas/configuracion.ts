...
export const tipoDocumentalSchema = z.object({
  ...
  requiereSegundoNivel: z.boolean().default(false),
  nivelN1: z.enum(["gerente", "jefatura", "analista", "operativo"]).optional().or(z.literal("")),
  nivelN2: z.enum(["gerente", "jefatura", "analista", "operativo"]).optional().or(z.literal("")),
  nivelRevisor: z.enum(["gerente", "jefatura", "analista", "operativo"]).optional().or(z.literal("")),

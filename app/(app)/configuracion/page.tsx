...
import {
  ...
  UserCheck, Archive, ChevronRight, Settings, Briefcase, ShieldCheck, FileClock, SlidersHorizontal, Palette,
} from "lucide-react";
...
export default async function ConfiguracionPage() {
  ...
  const secciones = [
    ...
    { href: "/configuracion/apariencia", icon: Palette, label: "Apariencia", desc: "Tema visual del sistema: paleta, barra superior y forma.", conteo: undefined, disponible: true },

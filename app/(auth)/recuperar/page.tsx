      ...
      <aside className="relative hidden lg:flex flex-col justify-between p-12 bg-foreground text-background overflow-hidden">
        ...
        <div className="relative z-10 space-y-6 max-w-md">
          <p className="font-serif text-4xl leading-tight">
            Recuperá el acceso
            <span className="text-accent"> a tu cuenta</span>
          </p>
          <p className="text-base text-background/70 leading-relaxed">
            Te enviaremos un enlace seguro a tu correo para que puedas crear una
            contraseña nueva y volver a ingresar al sistema.
          </p>
        </div>
        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Restablecé el acceso a tu cuenta del SGI.
            </p>
          </div>

...
/**
 * Card individual de un proceso en el mapa.
 *
 * - Clickeable: navega a /procesos/[codigo]
 * - Acento de color por proceso usando el color_hex de la BD (sutil, solo en una banda lateral)
 * - Hover state que invita a la interacción
 */
export function ProcessCard({ proceso }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Cabecera: icono + flecha de hover */}
